            ...
            <div class="space-y-5">
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    ...
                    <label class="block">
                        ...
                        <input name="sort_order" type="number" min="0" value="{{ old('sort_order',$category->sort_order ?? 0) }}" class="admin-input">
                        <small class="mt-2 block text-xs leading-5 text-slate-500 dark:text-slate-400">Angka kecil tampil lebih awal. Boleh dibiarkan 0.</small>
                    </label>
                </div>
