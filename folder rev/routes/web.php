...
Route::get('/testimoni', [StoreController::class, 'testimonials'])->name('testimonials.index');
Route::post('/testimoni', [StoreController::class, 'storeTestimonial'])->name('testimonials.store');
