            ...
            <div class="space-y-5">
                <div class="grid gap-4 lg:grid-cols-2">
                    ...
                    <label class="block">
                        ...
                        <input name="sort_order" type="number" min="1" value="{{ old('sort_order', $product->exists ? max(1, (int) $product->sort_order) : ($nextSortOrder ?? 1)) }}" class="admin-input">
                        <small class="mt-2 block text-xs leading-5 text-slate-500 dark:text-slate-400">Isi posisi baru. Jika diisi 2, produk yang sebelumnya posisi 2 dan setelahnya otomatis bergeser.</small>
                    </label>
                </div>
