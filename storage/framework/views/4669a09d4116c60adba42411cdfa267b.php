...
<head>
    ...
    <title><?php echo $__env->yieldContent('page_title', 'Dashboard'); ?> - <?php echo e($adminStoreName); ?></title>
    ...
    <div class="flex items-center justify-between gap-3 border-b border-white/10 p-5">
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-3">
            <span class="grid h-12 w-12 place-items-center overflow-hidden rounded-2xl bg-teal-600 text-white shadow-lg shadow-teal-900/30">
                <?php if($adminLogoUrl): ?>
                    <img src="<?php echo e($adminLogoUrl); ?>" alt="<?php echo e($adminStoreName); ?>" class="h-full w-full object-cover">
                <?php else: ?>
                    <i class="ph ph-storefront text-2xl"></i>
                <?php endif; ?>
            </span>
            <span class="leading-tight">
                <span class="block text-lg font-extrabold tracking-tight"><?php echo e($adminStoreName); ?></span>
...
<div class="min-h-screen lg:pl-72">
    <header class="mobile-admin-header sticky top-0 z-30 border-b backdrop-blur-xl lg:hidden">
        <div class="flex items-center justify-between gap-3 px-4 py-3">
            ...
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex min-w-0 items-center gap-2 font-extrabold text-slate-950 dark:text-white">
                ...
                <span class="truncate leading-tight"><?php echo e($adminStoreName); ?><span class="block text-[10px] font-bold uppercase tracking-[.18em] text-teal-700 dark:text-teal-300">Admin</span></span>
            </a>
