    ...
    <div class="fixed inset-x-0 top-0 z-50 border-b border-slate-200/70 bg-white/85 backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/80">
        <nav class="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
            ...
            <div class="hidden items-center gap-8 text-sm font-semibold text-slate-600 dark:text-slate-300 md:flex">
                <a class="hover:text-teal-700 dark:hover:text-teal-300" href="<?php echo e(route('home')); ?>#produk">Produk</a>
                <a class="hover:text-teal-700 dark:hover:text-teal-300" href="<?php echo e(route('home')); ?>#voucher">Voucher</a>
                <a class="hover:text-teal-700 dark:hover:text-teal-300" href="<?php echo e(route('guide')); ?>">Panduan</a>
            </div>
            ...
            <div class="flex items-center gap-2">
                <button type="button" data-cart-toggle class="relative grid h-11 w-11 place-items-center rounded-2xl border border-slate-200 bg-white text-slate-700 transition hover:-translate-y-0.5 hover:shadow-lg dark:border-white/10 dark:bg-white/10 dark:text-white" aria-label="Buka keranjang">
                    ...
                    <span data-cart-count-badge class="absolute -right-1 -top-1 grid h-5 min-w-5 place-items-center rounded-full bg-amber-500 px-1 text-xs font-bold text-white <?php echo e(($cart['count'] ?? 0) > 0 ? '' : 'hidden'); ?>"><?php echo e($cart['count'] ?? 0); ?></span>
                </button>
    ...
    <footer class="border-t border-slate-200 bg-white py-12 dark:border-white/10 dark:bg-slate-950">
        <div class="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 md:grid-cols-4 lg:px-8">
            <div class="md:col-span-2">
                ...
                <p class="mt-4 max-w-md text-sm leading-7 text-slate-500 dark:text-slate-400"><?php echo e(config('store.tagline')); ?> Pilih produk, masukkan keranjang, lalu lanjutkan konfirmasi pesanan melalui WhatsApp.</p>
            </div>
            <div>
                <h4 class="font-bold">Navigasi</h4>
                <div class="mt-4 space-y-3 text-sm text-slate-500 dark:text-slate-400">
                    <a class="block hover:text-teal-700 dark:hover:text-teal-300" href="<?php echo e(route('home')); ?>#produk">Produk</a>
                    <a class="block hover:text-teal-700 dark:hover:text-teal-300" href="<?php echo e(route('home')); ?>#keunggulan">Fitur</a>
                    <a class="block hover:text-teal-700 dark:hover:text-teal-300" href="<?php echo e(route('guide')); ?>">Panduan</a>
                </div>
            </div>
            <div>
