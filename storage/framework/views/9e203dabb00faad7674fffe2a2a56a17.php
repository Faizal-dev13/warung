...
<head>
    ...
    <meta name="description" content="<?php echo e($storeTagline); ?>">
        ...
        <nav class="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
            <a href="<?php echo e(route('home')); ?>" class="group flex items-center gap-3">
                <span class="grid h-11 w-11 place-items-center overflow-hidden rounded-2xl bg-slate-950 text-white shadow-soft transition group-hover:-rotate-3 dark:bg-white dark:text-slate-950">
                    <?php if($storeLogoUrl): ?>
                        <img src="<?php echo e($storeLogoUrl); ?>" alt="<?php echo e($storeName); ?>" class="h-full w-full object-cover">
                    <?php else: ?>
                ...
                <div class="mb-4 rounded-3xl border border-emerald-100 bg-gradient-to-br from-emerald-50 to-teal-50 p-4 dark:border-emerald-400/15 dark:from-emerald-500/10 dark:to-teal-500/10">
                    <div class="flex items-center justify-between gap-4">
                        <div>
                            ...
                            <strong data-cart-subtotal data-checkout-total class="mt-1 block text-2xl font-extrabold text-slate-950 dark:text-white"><?php echo e($cart['subtotal_formatted'] ?? 'Rp0'); ?></strong>
                ...
                <form action="<?php echo e(route('checkout.whatsapp')); ?>" method="post" class="space-y-3">
                    ...
                    <div class="grid gap-3 sm:grid-cols-2">
                        ...
                        <label class="relative block">
                            ...
                            <input name="voucher" data-voucher-input data-voucher-preview-url="<?php echo e(route('voucher.preview')); ?>" placeholder="Voucher" class="h-12 w-full rounded-2xl border border-slate-200 bg-slate-50 py-3 pl-11 pr-4 text-sm font-semibold uppercase outline-none transition placeholder:normal-case placeholder:text-slate-400 focus:border-emerald-500 focus:bg-white focus:ring-4 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-900 dark:text-white dark:focus:border-emerald-300">
                        </label>
                    </div>
