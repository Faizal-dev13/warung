...
<?php if (! $__env->hasRenderedOnce('cb7e7c19-1b06-4e78-a6dd-0a9e31f2577c')): $__env->markAsRenderedOnce('cb7e7c19-1b06-4e78-a6dd-0a9e31f2577c'); ?>
    <style>
        html {
                ...
                <?php $__empty_1 = true; $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                        ...
                        $bannerMobileImageUrl = $bannerMobileImagePath
                            ...
                            : null;
                    ?>
                    <article data-banner-slide class="<?php echo e($loop->first ? '' : 'hidden'); ?> relative min-h-[300px] overflow-hidden <?php echo e($bannerImageUrl ? 'bg-slate-950' : 'bg-gradient-to-br '.($banner->accent ?: 'from-slate-950 to-teal-900')); ?> p-6 text-white sm:min-h-[380px] sm:p-10">
                        <?php if($bannerImageUrl): ?>
                            <picture class="absolute inset-0 h-full w-full">
                                ...
                                <?php endif; ?>
                                <img src="<?php echo e($bannerImageUrl); ?>" alt="<?php echo e($banner->title); ?>" class="h-full w-full object-cover">
                            </picture>
                        ...
                        <div class="relative z-10 flex h-full min-h-[252px] flex-col justify-between gap-8 sm:min-h-[300px]">
                            ...
                            <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                                <a href="<?php echo e($banner->button_url ?: '#produk'); ?>" class="inline-flex items-center justify-center gap-2 rounded-2xl bg-white px-5 py-3.5 text-sm font-extrabold text-slate-950 shadow-lg shadow-black/10 transition hover:-translate-y-0.5 hover:shadow-xl sm:px-6 sm:py-4">
                                    <?php echo e($banner->button_text ?: 'Lihat Katalog'); ?> <i class="ph ph-arrow-right"></i>
                                </a>
...
<section id="produk" class="mx-auto max-w-7xl px-4 py-7 sm:px-6 sm:py-10 lg:px-8">
    ...
    <form method="get" action="<?php echo e(route('home')); ?>#produk" class="mb-6 rounded-[1.5rem] border border-slate-200 bg-white p-3 shadow-sm dark:border-white/10 dark:bg-white/5 sm:mb-8 sm:rounded-[2rem] sm:p-4">
...
<nav class="mobile-bottom-menu fixed inset-x-0 bottom-0 z-50 px-3 md:hidden">
    <div class="mx-auto grid max-w-md grid-cols-4 gap-1 rounded-[1.45rem] border border-slate-200/80 bg-white/95 p-2 shadow-[0_-12px_35px_rgba(15,23,42,.12)] backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/92">
        ...
        <button data-cart-toggle type="button" class="mobile-bottom-action">
            <span data-cart-count-badge class="absolute right-2 top-1 grid h-4 min-w-4 place-items-center rounded-full bg-amber-500 px-1 text-[9px] font-extrabold text-white <?php echo e(($cart['count'] ?? 0) > 0 ? '' : 'hidden'); ?>"><?php echo e($cart['count'] ?? 0); ?></span>
