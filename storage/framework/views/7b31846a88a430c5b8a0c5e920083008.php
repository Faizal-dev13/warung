...
<?php if (! $__env->hasRenderedOnce('22f4921d-c22c-434e-9db0-7cf47c1eeb43')): $__env->markAsRenderedOnce('22f4921d-c22c-434e-9db0-7cf47c1eeb43'); ?>
    <style>
        html {
                ...
                <?php $__empty_1 = true; $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                        ...
                        $bannerMobileImageUrl = $bannerMobileImagePath
                            ...
                            : null;
                    ?>
                    <article data-banner-slide class="<?php echo e($loop->first ? '' : 'hidden'); ?> relative min-h-[300px] overflow-hidden <?php echo e($bannerImageUrl ? 'bg-slate-950' : 'bg-gradient-to-br '.($banner->accent ?: 'from-slate-950 to-blue-950')); ?> p-6 text-white sm:min-h-[380px] sm:p-10">
